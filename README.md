...
Під час записів с 10 нод, була призупинена primary нода MongoDB, і процес запису був в принципі призупинений, доки знову не буде піднята 3-тя нода. Після повернення цієї ноди до кластеру, запис продовжився, але була невеличка втрата записів
...
В цьому випадку спостерігається та сама поведінка в контексті очікування підняття 3-ї ноди, проте втрат при запису немає
![img_11.png](img/img_11.png)
## В останніх двох випадках немає сенсу вимірювати витрачений час, оскільки клієнт зависає, доки не підніметься призупинена нода, хоч і подальші записи будуть проводитись на новообрану primary ноду. Хоча, можна зазначити, що majority очікувано робив записи повільніше.